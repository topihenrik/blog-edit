            ...
            <div className="signup-box">
                ...
                <form className="signup-form" onSubmit={handleSubmit}>
                    ...
                    <div className="signup-avatar-box">
                        <label className="signup-avatar-label" htmlFor="avatar"><img id="upload-icon" src={uploadIcon}/><span className="signup-avatar-span">{file?file.name:"Avatar image"}</span><span className="signup-avatar-span max-size">{"(max: 2MB)"}</span></label>
